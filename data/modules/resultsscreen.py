def beatres():
    ...
    if activity==5:
        ...
        render('rect',arg=(scrop,(20,20,20),False),borderradius=20)
        ...
        render('text', text='pp - '+str(str(format(int(perf),',')))+'/'+str(str(str(format(maxperf,',')))), arg=((w//2-150,h//2-100+75), forepallete,'center'),relative=(scrop[0],scrop[1]+150,scrop[2],scrop[3]))
        ...
        if not username=='Guest':
            ...
            render('text', text='Overall Points - '+str(format(totperf,',')), arg=((0,0), forepallete,'center'),relative=(scrop[0],scrop[1]+270,scrop[2],scrop[3]))
        ...
        butt=menu_draw(((scrop[0]-90,scrop[1]+400,scrop[2]*3-20,scrop[3]//2),),('Continue',),styleid=2)
