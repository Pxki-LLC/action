def logo():
    ...
    if activity==0:
        ...
        if gameverfake[2]>=32:
#            gamepre='Target is '
            gamepre='Welcome to '+gamename+'/'+gameedition+' '
...
#        else:
        ...
        render('text', text=gamepre+gamesuf, arg=((0,0), titlelogo,'center','grade'),relative=(w//2,h//2+100+(tokab),1,1))
        render('text', text='This Game is in Heavy Development', arg=((0,0), hovcol,'center'),relative=(w//2,h//2+60+prof+100+(tokab),1,1))
        render('text', text='', arg=((0,0), hovcol,'center'),relative=(w//2,h//2+100+prof+(tokab),1,1))
