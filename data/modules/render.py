...
def fullscreenchk():
    global w, h, w, h,background,fieldpos,modsv ,screen,reload,transani,modsani, button_size_width, firstcom,tal,keymap,fonts,volani,noteheight,logopos,bladeani
    reload=False
